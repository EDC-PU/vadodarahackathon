                ...
                <div className="mt-4 flex items-center gap-4 border-t pt-4">
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            ...
                            <AlertDialogDescription>
                                This will permanently delete the selected {selectedUserIds.length} user(s) and any teams they are leaders of. Admin accounts will be skipped. This action cannot be undone.
                            </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
