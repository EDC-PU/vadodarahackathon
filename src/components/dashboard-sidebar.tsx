  ...
  return (
    <>
      <SidebarHeader className="border-b">
        <div className="flex items-center justify-center gap-2 w-full p-2 h-20">
          <Image src="https://www.pierc.org/vhlogo.png" alt="Vadodara Hackathon Logo" width={56} height={56} />
        </div>
      </SidebarHeader>
      <SidebarContent className="p-2">
        <SidebarMenu>
